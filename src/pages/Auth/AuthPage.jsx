            ...
            <div className="flex-1 lg:max-w-lg flex flex-col justify-between p-8 lg:p-16">
                ...
                <div className="flex-1 flex flex-col justify-center max-w-sm mx-auto w-full">
                    ...
                    <div className="bg-white p-8 shadow-sm">
                        ...
                        <button className="w-full flex items-center justify-center gap-3 py-3 border border-gray-200 text-xs tracking-widest uppercase hover:border-gray-400 transition-colors" style={{ color: '#0D1F3C' }}>
